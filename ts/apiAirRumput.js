...
var charizardCounter = evolvetoCharizard();
yourPokemon === null || yourPokemon === void 0 ? void 0 : yourPokemon.addEventListener('dblclick', function () {
    var value = charizardCounter.next().value;
    if (value === 3) {
...
chooseCharacterButton === null || chooseCharacterButton === void 0 ? void 0 : chooseCharacterButton.addEventListener('click', function () {
...
function DisplayCharacter(characterArray) {
    ...
    characterArray.forEach(function (item) {
        ...
        characterDisplayContainer === null || characterDisplayContainer === void 0 ? void 0 : characterDisplayContainer.appendChild(newDiv);
