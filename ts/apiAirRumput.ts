...
const welcomeDescription = document.getElementById("welcomeDescription") as HTMLParagraphElement | null;
const welcomeTitle:any = document.getElementById("welcomeTitle");
const welcomeContainer = document.getElementById("welcomeContainer") as HTMLDivElement | null;
const gameInstruction = document.getElementById("gameInstruction") as HTMLDivElement | null;
...
const yourHPContainer = document.getElementById("yourHPContainer") as HTMLDivElement | null;
const yourHP = document.getElementById("yourHP") as HTMLDivElement | null;
const enemyHPContainer = document.getElementById("enemyHPContainer")  as HTMLDivElement | null;
...
const physicalAttackCount = document.getElementById("physicalAttackCount") as HTMLSpanElement | null;
const totalRoundCount:any = document.getElementById("totalRoundCount");
const enemyPokemonContainer = document.getElementById("enemyPokemonContainer")  as HTMLDivElement | null;
const yourPokemonContainer = document.getElementById("yourPokemonContainer")  as HTMLDivElement | null;
const elementEnemy = document.getElementById("elementEnemy")  as HTMLDivElement | null;
const elementYou = document.getElementById("elementYou")  as HTMLDivElement | null;
const enemyPokemon = document.getElementById("enemyPokemon") as HTMLImageElement | null;
const yourPokemon = document.getElementById("yourPokemon") as HTMLImageElement | null;
const superEffectiveSound = document.getElementById("superEffectiveSound") as HTMLAudioElement | null;
const NotEffectiveSound = document.getElementById("NotEffectiveSound") as HTMLAudioElement | null;
const playAgainButton = document.getElementById("playAgainButton") as HTMLAudioElement | null;
const battleSong = document.getElementById("battleSong") as HTMLAudioElement | null;
const victorySong = document.getElementById("victorySong") as HTMLAudioElement | null;
const defeatedSong = document.getElementById('defeatedSong') as HTMLAudioElement | null;
const tieSong = document.getElementById('tieSong')  as HTMLAudioElement | null;
const opening = document.getElementById('opening') as HTMLAudioElement | null;
const characterSelectionContainer = document.getElementById('characterSelectionContainer') as HTMLDivElement | null;
const chooseCharacterButton = document.getElementById('chooseCharacterButton') as HTMLButtonElement | null;
const characterDisplayContainer = document.getElementById('characterDisplayContainer') as HTMLDivElement | null;
const yourName = document.getElementById('yourName') as HTMLParagraphElement | null;
const enemyName = document.getElementById('enemyName') as HTMLParagraphElement | null;
const gameStory = document.getElementById('gameStory') as HTMLParagraphElement | null;
const chooseCharacterText = document.getElementById('chooseCharacterText') as HTMLParagraphElement | null;
const generationList = document.getElementById('generationList') as HTMLUListElement | null;
const charactersClass = document.getElementsByClassName('character');
const yourHealthBar = document.getElementById('yourHealthBar') as HTMLDivElement | null;
const duelContainer = document.getElementById("duelContainer") as HTMLDivElement | null;
